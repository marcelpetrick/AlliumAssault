...
| Crates       | Optional health and weapon crates: Off / Normal / Lots / Cratyness (see below)          |
...
Twenty-two weapons. _Special_ weapons can be restricted to crates with the arsenal setting.
...
single crate, Cratyness brings two every turn. At most four crates lie about per crate a turn
brings, so four normally and eight under Cratyness. Health crates heal the collecting buddy by 25 HP; weapon crates add one
