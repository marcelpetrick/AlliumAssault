  ...
  constructor(
    ...
    this.weapons = {
      ...
      airstrike: this.buildWeapon(scene, attach, [
        [MeshBuilder.CreateBox('radio', { width: 0.22, height: 0.34, depth: 0.14 }, scene), kit.olive, [0.55, 0, 0], false],
        [MeshBuilder.CreateCylinder('antenna', { height: 0.4, diameter: 0.025, tessellation: 6 }, scene), kit.metal, [0.6, 0.35, 0], false],
      ]),
      bat: this.buildWeapon(scene, attach, [
      ...
      rope: this.buildWeapon(scene, attach, [
        [MeshBuilder.CreateCylinder('ropeGun', { height: 0.5, diameter: 0.14, tessellation: 10 }, scene), kit.metal, [0.5, 0, 0], true],
        [MeshBuilder.CreateTorus('ropeCoil', { diameter: 0.26, thickness: 0.06, tessellation: 12 }, scene), kit.wood, [0.25, -0.12, 0], false],
      ]),
